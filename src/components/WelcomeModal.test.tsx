...
describe('WelcomeModal', () => {
  ...
  it('clicking recruiter quick option calls onSelect with recruiter', () => {
    ...
    const recruiterButtons = screen
      .getAllByRole('button')
      .filter((btn) => btn.textContent?.includes('Recruiter'));
  ...
  it('clicking developer quick option calls onSelect with developer', () => {
    ...
    const developerButtons = screen
      .getAllByRole('button')
      .filter((btn) => btn.textContent?.includes('Developer'));
  ...
  it('clicking collaborator quick option calls onSelect with collaborator', () => {
    ...
    const collaboratorButtons = screen
      .getAllByRole('button')
      .filter((btn) => btn.textContent?.includes('Collaborator'));
  ...
  it('clicking friend quick option calls onSelect with friend', () => {
    ...
    const friendButtons = screen
      .getAllByRole('button')
      .filter((btn) => btn.textContent?.includes('Friend'));
