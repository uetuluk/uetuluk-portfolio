...
export function ContactSection({
  ...
  const { contact } = portfolio.personal;

  const contactLinks = [
    {
      key: 'email',
      show: showEmail && contact.email,
    ...
    {
      key: 'linkedin',
      show: showLinkedIn && contact.linkedin,
    ...
    {
      key: 'github',
      show: showGitHub && contact.github,
      href: contact.github,
      label: 'GitHub',
  ...
  const visibleLinks = contactLinks.filter((link) => link.show);
  ...
  return (
    <section className={cn('py-8', className)}>
      ...
      <div className="bg-card rounded-xl border p-6">
        <p className="text-muted-foreground mb-6">{t('contact.intro')}</p>
