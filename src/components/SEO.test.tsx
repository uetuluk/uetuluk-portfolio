...
describe('SEO', () => {
  ...
  describe('meta tags', () => {
    ...
    it('includes meta description from bio by default', () => {
      ...
      expect(descMeta?.content).toBe('A passionate developer building great software.');
    });
  ...
  describe('Open Graph tags', () => {
    ...
    it('includes og:description', () => {
      ...
      expect(ogDesc?.content).toBe('A passionate developer building great software.');
    });
  ...
  describe('Twitter Card tags', () => {
    ...
    it('includes twitter:description', () => {
      ...
      expect(twitterDesc?.content).toBe('A passionate developer building great software.');
    });
