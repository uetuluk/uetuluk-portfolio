...
describe("LoadingScreen", () => {
  ...
  describe("basic rendering", () => {
    ...
    it("renders subtitle from translations", () => {
      render(<LoadingScreen visitorType="recruiter" />);
      expect(
        screen.getByText("Our AI is personalizing your view...")
      ).toBeInTheDocument();
    });
  ...
  describe("visitor type messages", () => {
    it("shows recruiter messages for recruiter visitor type", () => {
      render(<LoadingScreen visitorType="recruiter" />);
      expect(
        screen.getByText("Highlighting key achievements...")
      ).toBeInTheDocument();
      expect(
        screen.getByText("Preparing skills showcase...")
      ).toBeInTheDocument();
      expect(
        screen.getByText("Organizing career timeline...")
      ).toBeInTheDocument();
    });
    ...
    it("shows developer messages for developer visitor type", () => {
      ...
      expect(
        screen.getByText("Loading technical projects...")
      ).toBeInTheDocument();
    ...
    it("shows collaborator messages for collaborator visitor type", () => {
      ...
      expect(
        screen.getByText("Preparing collaboration highlights...")
      ).toBeInTheDocument();
    });
    ...
    it("shows no messages when visitorType is null", () => {
      ...
      expect(
        screen.queryByText("Highlighting key achievements...")
      ).not.toBeInTheDocument();
      expect(
        screen.queryByText("Loading technical projects...")
      ).not.toBeInTheDocument();
    });
  });
