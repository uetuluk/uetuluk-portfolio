...
export function SEO({
  ...
  useHead({
    ...
    meta: [
      ...
      { property: "og:image:alt", content: `${portfolio.personal.name} - ${portfolio.personal.title}` },
      ...
      { name: "twitter:image:alt", content: `${portfolio.personal.name} - ${portfolio.personal.title}` },
    ],
